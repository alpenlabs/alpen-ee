...
prover-eval: prover-clean
    cd {{prover_perf_eval_dir}} && RUST_LOG=info SP1_PROVER=light ZKVM_MOCK=1 ZKVM_PROFILING=1 SP1_ALPEN_PARAMS_PATH={{justfile_directory()}}/bin/alpen-client/tests/res/alpen-params.json cargo run --release -- --programs {{prover_programs}}
