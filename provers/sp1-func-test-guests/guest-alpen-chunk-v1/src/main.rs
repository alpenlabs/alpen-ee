...
/// `build.rs` from the file at `SP1_ALPEN_PARAMS_PATH_V1`. Not zkVM input —
/// see `strata_proofimpl_alpen_chunk::process_ee_chunk` for why.
mod alpen_params {
    include!(concat!(env!("CARGO_MANIFEST_DIR"), "/../generated/v1/alpen_params.rs"));
}
