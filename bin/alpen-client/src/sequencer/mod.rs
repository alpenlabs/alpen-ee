        ...
        + 'static,
{
    ...
    let batch_prover = provers::launch(
        ...
        provers::EeProverInputs {
            ...
            dev_native_prover: sequencer_args.prover.dev_native_prover,
            sp1_deadline_secs: sequencer_args.prover.sp1_proof_deadline_secs,
            chunk_elf_path: sequencer_args.prover.chunk_elf_path.clone(),
            acct_elf_path: sequencer_args.prover.acct_elf_path.clone(),
            params: params.clone(),
        },
    )
    .await?;
